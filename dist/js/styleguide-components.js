...
!function(angular) {
    ...
    var templateAsString = " \t\t\t<div class='row'> \t\t\t\t<div class='col-sm-5 tw-date-month-column' ng-if='vm.monthBeforeDay'> \t\t\t\t\t<label class='sr-only' for='month-{{::uniqueId}}'>Month</label> \t\t\t\t\t<tw-select \t\t\t\t\t\tname='month' \t\t\t\t\t\tclass='tw-date-month' \t\t\t\t\t\tid='month-{{::uniqueId}}' \t\t\t\t\t\tng-model='vm.month' \t\t\t\t\t\tng-change='vm.updateDateModelAndValidationClasses()' \t\t\t\t\t\tng-required='vm.dateRequired' \t\t\t\t\t\tng-disabled='vm.dateDisabled' \t\t\t\t\t\toptions='vm.dateMonths'> \t\t\t\t\t</tw-select> \t\t\t\t</div> \t\t\t\t<div class='col-sm-3 tw-date-day-column'> \t\t\t\t\t<label class='sr-only' for='day-{{::uniqueId}}'>Day</label> \t\t\t\t\t<input type='number' \t\t\t\t\t\tname='day' \t\t\t\t\t\tid='day-{{::uniqueId}}' \t\t\t\t\t\tclass='form-control tw-date-day' \t\t\t\t\t\tng-model='vm.day' \t\t\t\t\t\tng-change='vm.updateDateModelAndValidationClasses()' \t\t\t\t\t\tplaceholder='DD' \t\t\t\t\t\tmin='1' \t\t\t\t\t\tng-min='1' \t\t\t\t\t\tng-disabled='vm.dateDisabled' \t\t\t\t\t\tng-required='vm.dateRequired' \t\t\t\t\t\ttw-focusable /> \t\t\t\t</div> \t\t\t\t<div class='col-sm-5 tw-date-month-column' ng-if='!vm.monthBeforeDay'> \t\t\t\t\t<label class='sr-only' for='month-{{::uniqueId}}'>Month</label> \t\t\t\t\t<tw-select \t\t\t\t\t\tname='month' \t\t\t\t\t\tclass='tw-date-month' \t\t\t\t\t\tid='month-{{::uniqueId}}' \t\t\t\t\t\tng-model='vm.month' \t\t\t\t\t\tng-change='vm.updateDateModelAndValidationClasses()' \t\t\t\t\t\tng-required='vm.dateRequired' \t\t\t\t\t\tng-disabled='vm.dateDisabled' \t\t\t\t\t\toptions='vm.dateMonths'> \t\t\t\t\t</tw-select> \t\t\t\t</div> \t\t\t\t<div class='col-sm-4 tw-date-year-column'> \t\t\t\t\t<label class='sr-only' for='year-{{::uniqueId}}'>Year</label> \t\t\t\t\t<input type='number' \t\t\t\t\t\tid='year-{{::uniqueId}}' \t\t\t\t\t\tname='year' \t\t\t\t\t\tclass='form-control tw-date-year' \t\t\t\t\t\tplaceholder='YYYY' \t\t\t\t\t\tng-model='vm.year' \t\t\t\t\t\tng-change='vm.updateDateModelAndValidationClasses()' \t\t\t\t\t\tng-min='vm.dateRange.min.getFullYear()' \t\t\t\t\t\tng-max='vm.dateRange.max.getFullYear()' \t\t\t\t\t\tmaxlength='4' \t\t\t\t\t\tng-maxlength='4' \t\t\t\t\t\tng-disabled='vm.dateDisabled' \t\t\t\t\t\tng-required='vm.dateRequired' \t\t\t\t\t\ttw-focusable /> \t\t\t\t</div> \t\t\t</div>";
}(window.angular), function(angular) {
