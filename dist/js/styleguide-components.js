...
var _domService = __webpack_require__(85);
...
var _dateService = __webpack_require__(18);
...
var _formValidation = __webpack_require__(90);

var _formValidation2 = _interopRequireDefault(_formValidation);

var _controlValidation = __webpack_require__(88);
...
function DateService() {
  ...
  this.getDateTimePresentation = function (hours, minutes, locale) {
  ...
  this.getYearAndMonthShortPresentation = function (year, month, locale) {
    locale = getValidLocale(locale);
    var lang = getLanguageFromLocale(locale);
    if (lang === 'ja') {
  ...
  this.getYearMonthDateShortPresentation = function (year, month, date, locale) {
    locale = getValidLocale(locale);
    var lang = getLanguageFromLocale(locale);
    if (lang === 'ja') {
  ...
  this.getMonthDatePresentation = function (monthName, date, locale) {
    locale = getValidLocale(locale);
    var lang = getLanguageFromLocale(locale);
    if (lang === 'ja') {
  ...
  this.getMonthDateShortPresentation = function (month, date, locale) {
    locale = getValidLocale(locale);
    var lang = getLanguageFromLocale(locale);
    if (lang === 'ja') {
...
var _dateFormatFilter = __webpack_require__(25);
...
var _dateFormatService = __webpack_require__(26);
...
function DateFormatFilter(TwDateFormatService) {
  return function (date, locale, patternName, hasWeekday, hasDayTime, hasSuffix) {
    if (!date) {
      return date;
    }

    return TwDateFormatService.getDateFormat(date, locale, patternName, hasWeekday, hasDayTime, hasSuffix);
  };
}
...
function DateFormatService() {
  this.getDateFormat = function (date, locale, patternName, hasWeekday, hasDayTime, hasSuffix) {
    var dateService = new _dateService2.default();
    var weekday = dateService.getDayNamesForLocale(locale, 'long')[date.getDay()];
    var hasYear = true;
    var isShort = false;
    var year = date.getFullYear();
    var month = dateService.getMonthNamesForLocale(locale, 'long')[date.getMonth()];
    ...
    // Return the result
    if (isShort) {
      result = hasYear ? dateService.getYearMonthDateShortPresentation(year, month, monthDate, locale) : dateService.getMonthDateShortPresentation(month, monthDate, locale);
    } else {
      result = hasYear ? dateService.getYearMonthDatePresentation(year, month, monthDate, locale) : dateService.getMonthDatePresentation(month, monthDate, locale);
    }
    if (hasWeekday) {
      if (locale === 'ja') {
    ...
    if (hasDayTime) {
      var dayTime = dateService.getDateTimePresentation(date.getHours(), date.getMinutes(), locale);
...
var _amountCurrencySelect = __webpack_require__(91);
...
var _currencyInput = __webpack_require__(93);
...
var _dateLookup = __webpack_require__(94);
...
var _date = __webpack_require__(95);
...
var _fieldset = __webpack_require__(97);
...
var _requirementsForm = __webpack_require__(99);
...
var _uploadDroppable = __webpack_require__(101);
...
var _cards = __webpack_require__(104);
...
var _process = __webpack_require__(106);
...
var _tabs = __webpack_require__(107);
...
var _controlValidationController = __webpack_require__(86);
...
var _controlValidationDirective = __webpack_require__(87);
...
var _formValidationDirective = __webpack_require__(89);
