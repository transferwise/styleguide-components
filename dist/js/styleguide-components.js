...
!function(angular) {
    ...
    function TwDateLookupController($element, $scope, $timeout, TwDateService) {
        function init() {
            $ctrl.yearOffset = 0, ngModelCtrl = $element.controller("ngModel"), ngModelCtrl.$validators.required = function(value) {
                ...
                newValue && newValue !== oldValue && (ngModelCtrl.$setDirty(), ngModelCtrl.$setTouched(), 
                updateModelDate(newValue, !0));
            }), $scope.$watch("$ctrl.ngRequired", function(newValue, oldValue) {
                newValue && newValue !== oldValue && ngModelCtrl.$validate();
            }), $scope.$watch("$ctrl.ngMin", function(newValue, oldValue) {
                newValue !== oldValue && (updateMinDate($ctrl.ngMin), $ctrl.ngModel < $ctrl.ngMin && updateModelDate(null), 
                ngModelCtrl.$validate());
            }), $scope.$watch("$ctrl.ngMax", function(newValue, oldValue) {
                newValue !== oldValue && (updateMaxDate($ctrl.ngMax), $ctrl.ngModel > $ctrl.ngMax && updateModelDate(null), 
                ngModelCtrl.$validate());
            }), $ctrl.ngModel && $ctrl.ngModel.getUTCDate ? ($ctrl.day = $ctrl.ngModel.getUTCDate(), 
            $ctrl.month = $ctrl.ngModel.getUTCMonth(), $ctrl.year = $ctrl.ngModel.getUTCFullYear()) : $ctrl.resetDate(), 
        ...
        function updateModelDate(modelDate, dontSetVal) {
            modelDate = moveDateToWithinRange(modelDate, $ctrl.ngMin, $ctrl.ngMax), dontSetVal ? ngModelCtrl.$validate() : (ngModelCtrl.$setViewValue(modelDate), 
            ngModelCtrl.$setDirty(), ngModelCtrl.$setTouched()), modelDate && modelDate.getUTCDate ? ($ctrl.selectedDate = modelDate.getUTCDate(), 
            $ctrl.selectedMonth = modelDate.getUTCMonth(), $ctrl.selectedYear = modelDate.getUTCFullYear(), 
            $ctrl.selectedMonth === $ctrl.month && $ctrl.selectedYear === $ctrl.year || ($ctrl.month = $ctrl.selectedMonth, 
            $ctrl.year = $ctrl.selectedYear, $ctrl.weeks = getTableStructure())) : ($ctrl.selectedDate = null, 
        ...
        $ctrl.openLookup = function() {
            ngModelCtrl.$setTouched(), $ctrl.mode = "day", $ctrl.ngModel && $ctrl.ngModel.getUTCDate ? ($ctrl.day = $ctrl.ngModel.getUTCDate(), 
            $ctrl.month = $ctrl.ngModel.getUTCMonth(), $ctrl.year = $ctrl.ngModel.getUTCFullYear()) : $ctrl.resetDate(), 
            $timeout(function() {
            ...
            updateModelDate(TwDateService.getUTCDate(year, month, day)), void resetFocus());
            ...
            focalDate = moveDateToWithinRange(focalDate, $ctrl.ngMin, $ctrl.ngMax), $ctrl.day = focalDate.getUTCDate(), 
            $ctrl.month = focalDate.getUTCMonth(), $ctrl.year = focalDate.getUTCFullYear(), 
    ...
    function TwDynamicFormControl() {
        return {
            ...
            template: "<div ng-switch='$ctrl.type'> \t\t\t\t<input ng-switch-when='text'  \t\t\t\t\tname='{{$ctrl.name}}'  \t\t\t\t\ttype='text' \t\t\t\t\tclass='form-control' \t\t\t\t\tplaceholder='{{$ctrl.placeholder}}' \t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\tng-model-options='{ allowInvalid: true }' \t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\tng-pattern='$ctrl.ngPattern' \t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\tng-blur='$ctrl.blur()' \t\t\t\t\tng-minlength='$ctrl.ngMinlength' \t\t\t\t\tng-maxlength='$ctrl.ngMaxlength' />  \t\t\t\t<input ng-switch-when='password'  \t\t\t\t\tname='{{$ctrl.name}}'  \t\t\t\t\ttype='password' \t\t\t\t\tclass='form-control' \t\t\t\t\tplaceholder='{{$ctrl.placeholder}}' \t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\tng-model-options='{ allowInvalid: true }' \t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\tng-blur='$ctrl.blur()' \t\t\t\t\tng-minlength='$ctrl.ngMinlength' \t\t\t\t\tng-maxlength='$ctrl.ngMaxlength' />  \t\t\t\t<input ng-switch-when='number'  \t\t\t\t\tname='{{$ctrl.name}}'  \t\t\t\t\ttype='number' \t\t\t\t\tstep='{{$ctrl.step}}' \t\t\t\t\tclass='form-control' \t\t\t\t\tplaceholder='{{$ctrl.placeholder}}' \t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\tng-model-options='{ allowInvalid: true }' \t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\tng-blur='$ctrl.blur()' \t\t\t\t\tng-min='$ctrl.ngMin' \t\t\t\t\tng-max='$ctrl.ngMax' />  \t\t\t\t<div ng-switch-when='radio' \t\t\t\t\tclass='radio' \t\t\t\t\tng-class='{disabled: $ctrl.ngDisabled}' \t\t\t\t\tng-repeat='option in $ctrl.options'> \t\t\t\t\t<label> \t\t\t\t\t\t<tw-radio \t\t\t\t\t\t\tname='{{$ctrl.name}}' \t\t\t\t\t\t\tng-value='option.value' \t\t\t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\t\t\tng-click='$ctrl.change()' \t\t\t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\t\t\tng-blur='$ctrl.blur()' /> \t\t\t\t\t\t{{option.label}} \t\t\t\t\t</label> \t\t\t\t</div> \t\t\t\t<div ng-switch-when='checkbox' \t\t\t\t\tclass='checkbox' \t\t\t\t\tng-class='{disabled: $ctrl.ngDisabled}'> \t\t\t\t\t<label> \t\t\t\t\t\t<tw-checkbox \t\t\t\t\t\t\tname='{{$ctrl.name}}' \t\t\t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\t\t\tng-click='$ctrl.change()' \t\t\t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\t\t\tng-blur='$ctrl.blur()' /> \t\t\t\t\t\t{{$ctrl.placeholder}} \t\t\t\t\t</label> \t\t\t\t</div> \t\t\t\t<div ng-switch-when='select'> \t\t\t\t\t<tw-select \t\t\t\t\t\tname='{{$ctrl.name}}' \t\t\t\t\t\toptions='$ctrl.options' \t\t\t\t\t\tplaceholder='{{$ctrl.placeholder}}' \t\t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\t\tng-blur='$ctrl.blur()' /> \t\t\t\t</div> \t\t\t\t<div ng-switch-when='upload'> \t\t\t\t\t<tw-upload \t\t\t\t\t\tname='{{$ctrl.name}}' \t\t\t\t\t\ticon='upload' \t\t\t\t\t\tdescription='{{$ctrl.placeholder}}' \t\t\t\t\t\tinstructions='Upload a file' \t\t\t\t\t\tbutton-text='Upload' \t\t\t\t\t\taccept='' \t\t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\t\tng-blur='$ctrl.blur()' /> \t\t\t\t</div> \t\t\t\t<div ng-switch-when='date'> \t\t\t\t\t<tw-date \t\t\t\t\t\tname='{{$ctrl.name}}' \t\t\t\t\t\tlocale='{{$ctrl.locale}}' \t\t\t\t\t\tng-min='$ctrl.ngMin' \t\t\t\t\t\tng-max='$ctrl.ngMax' \t\t\t\t\t\tng-model='$ctrl.ngModel' \t\t\t\t\t\tng-required='$ctrl.ngRequired' \t\t\t\t\t\tng-disabled='$ctrl.ngDisabled' \t\t\t\t\t\tng-change='$ctrl.change()' \t\t\t\t\t\tng-focus='$ctrl.focus()' \t\t\t\t\t\tng-blur='$ctrl.blur()' /> \t\t\t\t</div> \t\t\t\t<ng-transclude class='error-messages'></ng-transclude> \t\t\t</div>"
        };
    }
    ...
    function TwDateService() {
        ...
        this.getLastDayOfMonth = function(year, month) {
            ...
            return this.getUTCDate(date.getUTCFullYear() + years, date.getUTCMonth() + months, date.getUTCDate() + days);
        };
    }
