...
!function(angular) {
    ...
    function TwSelectController($element, $scope, $transclude, $timeout) {
        ...
        function selectOptionUsingLink(link) {
            var option = link.controller("twSelectOption").twSelectOption;
            selectOption($ngModel, $ctrl, option);
        }
    ...
    function TwSelectOptionDirective() {
        return {
            bindToController: !0,
            controller: function() {},
            controllerAs: "$ctrl",
    ...
    angular.module("tw.form-components").directive("twSelect", TwSelectDirective), angular.module("tw.form-components").directive("twSelectOption", TwSelectOptionDirective);
}(window.angular), function(angular) {
    "use strict";
